...
public class PitonLexer extends Lexer {
	...
	public static final int
		...
		ENQ=10, OP_REF=11, OP_LOG=12, VAZ=13, ENT=14, SAI=15, IF=16, ELSE=17, 
		ELIF=18, REF=19, ID=20, NUM=21, AP=22, FP=23, EB=24, ErrorChar=25;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ENQ", "OP_REF", "OP_LOG", "VAZ", "ENT", "SAI", "IF", "ELSE", "ELIF", 
			"REF", "ID", "NUM", "LETRA", "DIGITO", "AP", "FP", "EB", "ErrorChar"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"OP_REF", "OP_LOG", "VAZ", "ENT", "SAI", "IF", "ELSE", "ELIF", "REF", 
